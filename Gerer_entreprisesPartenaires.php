...
if(isset($_SESSION["idUtilisateur"])) {
    ...
    } else if(isset($_REQUEST["boutonActiver"])) {
        $entreprise = Entreprise_Select_ParId($connexion, $_REQUEST["statusCompteId"]);

        switch($entreprise["statusCompte"]) {
            case 0:
                Entreprise_Changer_Status_ParId($connexion, $entreprise["idEntreprise"], "1");
                break;
            case 1:
                Entreprise_Changer_Status_ParId($connexion, $entreprise["idEntreprise"], "0");
                break;
        }
